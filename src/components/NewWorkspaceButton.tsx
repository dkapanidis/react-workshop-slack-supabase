...
function NewWorkspaceButton() {
  return (
    <div className="cursor-pointer">
      <div data-tip data-for="new-workspace" className="text-gray-400 hover:bg-gray-800 h-10 w-10 flex items-center justify-center text-2xl font-semibold rounded-lg mb-1 overflow-hidden">
      ...
      <ReactTooltip offset={{ right: 2 }} id="new-workspace" className="tooltip" place="right" effect="solid" delayShow={400} border={false} backgroundColor="transparent">
        <div className="bg-gray-800 p-1 border rounded-md border-gray-700 px-2 text-2xl text-gray-300 font-light">Add Workspace</div>
      </ReactTooltip>
