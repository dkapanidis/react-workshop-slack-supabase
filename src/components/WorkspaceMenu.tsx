...
function WorkspaceNewButton() {
  return (
    <div className="cursor-pointer">
      <div data-tip data-for="new-workspace" className="text-gray-400 hover:bg-gray-800 h-8 w-8 flex items-center justify-center text-xl font-semibold rounded-lg mb-1 overflow-hidden outline-none" onClick={() => { }}>
